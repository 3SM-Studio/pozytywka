        ...
        <div className="grid items-center gap-10 md:grid-cols-12">
          <div className="min-w-0 md:col-span-7">
            <div className="border-outline-variant/70 bg-surface-raised/70 relative isolate grid min-h-[352px] w-full min-w-0 place-items-center overflow-hidden rounded-[2rem] border p-4 shadow-2xl md:min-h-[496px]">
              <div aria-hidden="true" className="bg-ink absolute inset-4 -z-10 rounded-[1.5rem]" />
              <div
                aria-hidden="true"
                className="absolute inset-4 -z-10 rounded-[1.5rem] bg-[radial-gradient(circle_at_70%_30%,rgba(255,213,74,0.3),transparent_18rem),linear-gradient(135deg,rgba(255,243,215,0.12),transparent_42%)]"
              />
              <div
                aria-hidden="true"
                className="absolute inset-4 -z-10 rounded-[1.5rem] bg-black/20"
              />
          ...
          <div className="min-w-0 md:col-span-5">
            ...
            <h2
              id={headingId}
              className="text-foreground mt-4 font-serif text-5xl leading-tight font-semibold tracking-tight"
            >
              {content.title}
            </h2>
