...
export function TeamPreviewSection({content}: TeamPreviewSectionProps) {
  ...
  const hasTeamMembers = content.members.length > 0
    ...
    <Section id="o-pozytywce" labelledBy={headingId} tone="surface">
      <Container>
        ...
        <div className="grid gap-8 md:grid-cols-12">
          <article
            className={`border-outline-variant/60 bg-surface-container-low grid gap-8 rounded-2xl border p-8 md:grid-cols-[0.9fr_1fr] ${
              hasTeamMembers ? 'md:col-span-7' : 'md:col-span-8'
            }`}
          >
